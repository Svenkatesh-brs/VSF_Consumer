...
class _LoanOverviewCardState
    extends State<LoanOverviewCard>
  ...
  double get _repaymentProgress {
    ...
    final progress =
        1.0 - (widget.outstandingAmount / widget.loanAmount);
  ...
  Widget _buildRepaymentProgress() {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final progress =
            _repaymentProgress * animationValue;
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final bottomGlowX =
            math.cos(angle * 0.8) * 14;

        final bottomGlowY =
            math.sin(angle * 0.8) * 18;

        final shinePosition =
            -100 + (_glowController.value * 420);
...
class _PulsingStatusDot extends StatefulWidget {
  ...
  @override
  State<_PulsingStatusDot> createState() =>
      _PulsingStatusDotState();
}

class _PulsingStatusDotState
    extends State<_PulsingStatusDot>
