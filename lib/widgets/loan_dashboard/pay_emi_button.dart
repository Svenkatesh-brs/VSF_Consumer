...
class _PayEmiButtonState extends State<PayEmiButton>
  ...
  bool get _isDisabled => widget.isCompleted || widget.onTap == null;
      ...
      child: ScaleTransition(
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            final shineValue = _shineController.value;

            final glowOpacity = _isDisabled ? 0.0 : 0.18 + (pulseValue * 0.12);

            final glowBlur = _isPressed ? 8.0 : 20.0 + (pulseValue * 8);
